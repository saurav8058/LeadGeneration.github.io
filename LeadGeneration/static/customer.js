        ...
        data.map((item) => {
          htm += `<tr>
                    <th scope="row">${item.id}</th>
                        ...
                        <td><a href="tel:${item.mobileno}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                        ...
                        </svg><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
